...
Analysis of team performance (Math)
...
# 7. Extrahiere Performance-Metriken nach Schwierigkeitsgrad
...
# 8. Sauberen Datensatz für weitere Analysen erstellen - DIFFICULTY-BASED
math_analysis_data <- final_math_performance %>%
  select(participant.code, team_id, condition, 
         ...
         easy_success_rate, easy_trials, easy_timeups, easy_avg_time,
         optimal_selected_success_rate, optimal_selected_trials, optimal_selected_timeups, optimal_selected_avg_time,
         optimal_calibrated_success_rate, optimal_calibrated_trials, optimal_calibrated_timeups, optimal_calibrated_avg_time,
         hard_success_rate, hard_trials, hard_timeups, hard_avg_time)
...
Analysis of team performance (Hidden Profile)
...
# Extrahiere erweiterte HP Performance Metriken
extract_hp_extended_metrics <- function(df) {
  df %>%
    mutate(
      ...
      # Diskussionszeiten (in Sekunden konvertiert)
