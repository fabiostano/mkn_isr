...
test_extended_result <- parse_hp_extended(sample_team, sample_condition, sample_hp_order)
cat("Erweiterte HP Analyse Team 1 (Auszug):\n")
print(list(
  easy_discussion_time = test_extended_result$easy_discussion_time,
  optimal_discussion_time = test_extended_result$optimal_discussion_time,
  hard_discussion_time = test_extended_result$hard_discussion_time,
  easy_next_button = test_extended_result$easy_next_button,
  optimal_next_button = test_extended_result$optimal_next_button,
  hard_next_button = test_extended_result$hard_next_button
))
```
